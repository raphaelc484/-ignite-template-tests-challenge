...
import { CreateTransferStatementsController } from "../modules/statements/useCases/createTransferStatement/CreateTransferStatementsController";
...
const createTransferStatementsController = new CreateTransferStatementsController();
...
statementRouter.post(
  "/transfers/:user_id",
  createTransferStatementsController.handle
);
